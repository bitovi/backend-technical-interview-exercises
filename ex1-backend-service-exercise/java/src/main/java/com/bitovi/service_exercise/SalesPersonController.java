...
public class SalesPersonController {
    SalesPersonRepository salesPeopleRepository;
    ...
    public List<SalesPersonRepository.SalesPerson> getSales() {
         ...
         *
         * Step 2 - Fetch all records from the SalesPersonRepository and modify the monthly sales data based on the new parameter.
